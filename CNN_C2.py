...
for i in range(start_point, start_point+end_point):
    ...
    ref_img = ref_img[crop_h_s:crop_h_e, crop_w_s:crop_w_e, 0:2]
...
test_ref = test_ref.reshape(test_ref.shape[0], patch_size, patch_size, 2)
print(test_ref.shape)
...
train_ref = train_ref.reshape(train_ref.shape[0], patch_size, patch_size, 2)
